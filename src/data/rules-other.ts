...
import type { DiagnosticRule, Answer } from '../types';
import { hasValue, hasAnyValue, getAnswer } from './answer-utils';

export const migraineRules: DiagnosticRule[] = [
  {
    id: 'migraine_quality',
    condition: (a) =>
      hasValue(a, 'pain_quality', 'throbbing') && hasValue(a, 'location', 'one_side'),
...
export const otherRules: DiagnosticRule[] = [
  ...
  },
  {
    ...
    condition: (a) => hasAnyValue(a, 'medication_frequency', ['frequently', 'daily']),
