...
export const questions: Question[] = [
	// RED FLAG SCREENING (always first)
	{
		...
		subtext:
			'Like a "thunderclap" - the worst headache of your life, instantly',
		type: "single",
		options: [
	...
	},
	{
		...
		options: [
			{
				value: "fever_stiff_neck",
				label: "Fever with stiff neck",
				emoji: "🤒",
			},
			{
				value: "vision_changes",
				label: "Sudden vision changes or loss",
				emoji: "👁️",
			},
			{
				value: "confusion",
				label: "Confusion or difficulty speaking",
				emoji: "🧠",
			},
			{
				value: "weakness",
				label: "Weakness or numbness on one side",
				emoji: "💪",
			},
			{
				value: "after_injury",
				label: "This started after a head injury",
				emoji: "🤕",
			},
	...
	},
	{
		...
		options: [
			{
				value: "none_unusual",
				label: "None (but I usually have some)",
				emoji: "☕❌",
			},
	...
	},
	{
		...
		options: [
			...
			{
				value: "very_little",
				label: "Very little (under 5 hours)",
				emoji: "😵",
			},
...
export const diagnosticRules: DiagnosticRule[] = [
	...
	// TENSION HEADACHE
	{
		...
		condition: (answers) =>
			hasAnyValue(answers, "location", ["back", "neck", "temples", "all_over"]),
		weights: [
			{
				category: "tension",
				weight: 0.3,
				reason: "Location typical of tension headache",
			},
		],
	},
	{
		...
		condition: (answers) =>
			hasAnyValue(answers, "pain_quality", ["pressure", "dull", "tight_band"]),
		weights: [
			{
				category: "tension",
				weight: 0.3,
				reason: "Pressure/tightness quality suggests tension",
			},
		],
	},
	{
		...
		weights: [
			{
				category: "tension",
				weight: 0.4,
				reason: "Relief from neck stretching indicates muscular component",
			},
		],
	},
	{
		...
		condition: (answers) =>
			hasAnyValue(answers, "posture_activity", [
				"desk_work",
				"phone",
				"driving",
				"reading",
		...
		weights: [
			{
				category: "tension",
				weight: 0.3,
				reason: "Activity involves sustained posture",
			},
		],
	},
	{
		...
		condition: (answers) =>
			hasAnyValue(answers, "stress_level", ["high", "extreme"]),
		weights: [
			{
				category: "tension",
				weight: 0.3,
				reason: "Stress contributes to muscle tension",
			},
			{
				category: "stress",
				weight: 0.4,
				reason: "High stress is a headache trigger",
			},
		],
	},
		...
		weights: [
			{
				...
				weight: 0.4,
				reason: "Location suggests cervical origin",
			},
		],
	},
	{
		...
		weights: [
			{
				category: "cervicogenic",
				weight: 0.5,
				reason: "Response to neck work suggests cervicogenic",
			},
		],
	},
	{
		...
		weights: [
			{
				category: "cervicogenic",
				weight: 0.3,
				reason: "Extended screen time strains neck",
			},
		],
	},
	...
	// DEHYDRATION
	{
		...
		condition: (answers) =>
			hasAnyValue(answers, "water_intake", ["none", "little"]),
		weights: [
			{
				category: "dehydration",
				weight: 0.6,
				reason: "Insufficient fluid intake",
			},
		],
	},
	{
		...
		condition: (answers) =>
			hasAnyValue(answers, "alcohol_recent", ["several", "heavy"]),
		weights: [
			{
				category: "dehydration",
				weight: 0.4,
				reason: "Alcohol causes dehydration",
			},
			{
				category: "alcohol",
				weight: 0.6,
				reason: "Alcohol directly causes headaches",
			},
		],
	},
	...
	// CAFFEINE
	{
		...
		condition: (answers) =>
			hasAnyValue(answers, "caffeine_today", ["none_unusual", "less"]),
		weights: [
			{
				category: "caffeine_withdrawal",
				weight: 0.7,
				reason: "Reduced caffeine triggers withdrawal headache",
			},
		],
	},
	{
		...
		weights: [
			{
				category: "caffeine_excess",
				weight: 0.5,
				reason: "Excess caffeine can cause headaches",
			},
		],
	},
	...
	// HUNGER
	{
		...
		condition: (answers) =>
			hasAnyValue(answers, "last_meal", ["4_8h", "over_8h", "cant_remember"]),
		weights: [
			{
				category: "hunger",
				weight: 0.6,
				reason: "Low blood sugar from not eating",
			},
		],
	},
		...
		weights: [
			{
				category: "eye_strain",
				weight: 0.4,
				reason: "Location suggests eye strain",
			},
		],
	},
	{
		...
		weights: [
			{
				category: "eye_strain",
				weight: 0.6,
				reason: "Screen time with eye pain indicates strain",
			},
		],
	},
		...
		weights: [
			{
				...
				weight: 0.5,
				reason: "Lack of sleep triggers headaches",
			},
		],
	},
	{
		...
		weights: [
			{
				category: "sleep_deprivation",
				weight: 0.7,
				reason: "Waking with headache after poor sleep",
			},
		],
	},
	...
	},
	{
		...
		condition: (answers) =>
			hasValue(answers, "light_sound_sensitivity", "both"),
		weights: [
			{
				category: "migraine",
				weight: 0.5,
	...
	},
	{
		...
		condition: (answers) => {
			...
			if (
				hasAnyValue(answers, "light_sound_sensitivity", ["both", "light_only"])
			)
				count++;
	...
	// MEDICATION OVERUSE
	{
		...
		condition: (answers) =>
			hasAnyValue(answers, "medication_frequency", ["frequently", "daily"]),
		weights: [
			{
